...
<body>
	<div class = "container">
        ...
        <p><button id = "create">New User</button>
        <div id = "results">
            
	</div>
    <div id = "form">
        <div id = "errorText" class = "red"></div>
        <form id = "userForm" method = "post" action = "somewhere.php">
            <label>Username</label><input type = "text" id = "userUsername">
            <label>Password</label><input type = "password" id = "userPassword">
            <label>First Name</label><input type = "text" id = "userFirst">
            <label>Last Name</label><input type = "text" id = "userLast">
            <label>User Level</label><select id = "userLevel"><option value = "1">Admin</option><option value = "2">Dispatcher</option><option value = "3">Checkpoint Worker</option></select>
